...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '吴波的博客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个随心而行的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wb.730620.xyz', // 网站地址
